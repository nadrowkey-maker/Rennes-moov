...
// ==========================================================================
const DB = {
    familles: ["Marche", "Course", "Quadrupedie", "Saut", "Equilibre", "Grimper", "Lever", "Lancer", "Coordination", "Natation"],
    routes: {
        ...
        "gayeulles-2": { title: "Au Cœur des Gayeulles", type: "Intensif", time: "30 min", kcal: 600, level: "Sportif Confirmé", img: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=800&q=80", steps: [{ t: "Portage lourd", d: "Soulever et porter une souche de 20kg.", c: "Lever", xp: 150 }, { t: "Grimper de chêne", d: "Atteindre la 1ère branche à 2.5m.", c: "Grimper", xp: 200 }, { t: "Course boueuse", d: "Maintenir l'allure sur sol instable.", c: "Course", xp: 130 }] },
        ...
        "gayeulles-4": { title: "Le Sentier du Prédateur", type: "Nuit & Nature", time: "25 min", kcal: 320, level: "Sportif Confirmé", img: "https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=800&q=80", steps: [{ t: "Déplacement silencieux", d: "Marcher 500m sans faire de bruit sur sol de feuilles mortes.", c: "Marche", xp: 120 }, { t: "Exercice de grimper suspendu", d: "Atteindre la première branche et maintenir la position 30 secondes.", c: "Grimper", xp: 180 }] },
        ...
        "soeuvres-3": { title: "Les Clairières de Soeuvres", type: "Intensif", time: "35 min", kcal: 380, level: "Intense", img: "https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?auto=format&fit=crop&w=800&q=80", steps: [{ t: "Déplacement au sol", d: "30m de déplacement au sol sous obstacles.", c: "Quadrupedie", xp: 160 }, { t: "Lancer de précision", d: "Lancer précis sur cible naturelle à 8m.", c: "Lancer", xp: 100 }] },
        ...
        // ===== FORÊT DE TEILLAY =====
        "teillay-1": { title: "La Grande Traversée", type: "Trail Exigeant", time: "80 min", kcal: 720, level: "Sportif Confirmé", img: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=800&q=80", steps: [{ t: "Mise en condition", d: "2km de marche rapide en forêt primaire bretonne.", c: "Marche", xp: 70 }, { t: "Escalade intensive", d: "Grimper 5 arbres différents en moins de 20min.", c: "Grimper", xp: 250 }, { t: "Portage de charge", d: "Porter 30kg sur 100m en terrain accidenté.", c: "Lever", xp: 200 }, { t: "Course d'évasion", d: "1km de sprint sur terrain inconnu et varié.", c: "Course", xp: 150 }] },
        ...
        "teillay-3": { title: "L'Épreuve de l'Aube", type: "Niveau Expert", time: "55 min", kcal: 510, level: "Sportif Confirmé", img: "https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=800&q=80", steps: [{ t: "Ramper au sol", d: "30m de déplacement au sol en appui.", c: "Quadrupedie", xp: 170 }, { t: "Coordination dynamique", d: "Simuler 3 séquences de coordination et agilité.", c: "Coordination", xp: 140 }, { t: "Sprint d'urgence", d: "500m en sprint maximum sur terrain meuble.", c: "Course", xp: 120 }] },
 // ===== BOIS DE BEAUREGARD =====
        "beauregard-1": {
...
// Aperçu messages sur la home
    ...
    static renderInventory() {
        ...
        if (!c) return;
        if (Store.data.inventory.length === 0) { c.innerHTML = '<p class="text-gray-500 text-sm text-center mt-10">Sac nuit vide. Visitez la boutique.</p>'; return; }
    ...
    static handleNativePhoto(event) {
        ...
        reader.onload = (e) => {
            ...
            setTimeout(() => { if(text) text.innerText = "Vérification de la posture..."; }, 1200);
    ...
    static abortSession() {
        ...
        DynamicIsland.show('Abandon Nuit', 'Repli confirmé. Aucun gain.', 'times', true);
    }
}
...
class Search {
    ...
    static filter(query) {
        ...
        const levelColor = l => l === 'Sportif Confirmé' ? '#ef4444' : l === 'Intense' ? '#f97316' : l === 'Débutant' ? '#22c55e' : '#a3a3a3';
